...
int r_flag = 1, f_time, r_time, on_time;

#pragma vector=TIMER1_A1_VECTOR
__interrupt void ccr2_isr(void)
{
    if(TA1IV == 4)
    {
        if(r_flag)
...
int main(void)
{
    ...
    TA0CCTL1 = 0x00e0; // 0000 0000 1110 0000 No Capture Compare Reset/set
    TA0CCR1 = 60-1;  // 0 - 59
   

    TA1CTL = 0x0220; // 0000 0010 0010 0000 SMCLK /1 Continuous
    TA1CCTL2 = 0x4910; // 0100 1001 0001 0000 Capture on rising edge Synchronous capture
    TA1CCR2 = 0;  // 0
    __enable_interrupt();
